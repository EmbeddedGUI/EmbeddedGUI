...
static int gc9a01_init(egui_hal_lcd_driver_t *self, const egui_hal_lcd_config_t *config)
{
    ...
    egui_lcd_send_vendor_init_cmds(self->io, gc9a01_default_vendor_cmds,
                                   sizeof(gc9a01_default_vendor_cmds) / sizeof(gc9a01_default_vendor_cmds[0]));
...
/* Driver: draw_area */
static void gc9a01_draw_area(egui_hal_lcd_driver_t *self, int16_t x, int16_t y,
