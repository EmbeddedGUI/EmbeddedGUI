...
/* Driver: draw_area */
static void nv3022b_draw_area(egui_hal_lcd_driver_t *self, int16_t x, int16_t y,
...
static void nv3022b_setup_driver(egui_hal_lcd_driver_t *driver,
...
void egui_lcd_nv3022b_init(egui_hal_lcd_driver_t *storage,
                            egui_panel_io_handle_t io,
                            void (*set_rst)(uint8_t level))
{
