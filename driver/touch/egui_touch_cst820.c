#if defined(EGUI_DRIVER_TOUCH_CST820_ENABLE) && EGUI_DRIVER_TOUCH_CST820_ENABLE
...
static void cst820_setup_driver(egui_hal_touch_driver_t *driver, egui_panel_io_handle_t io, void (*set_rst)(uint8_t level), void (*set_int)(uint8_t level),
