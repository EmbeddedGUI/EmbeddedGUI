#if defined(EGUI_DRIVER_TOUCH_GT1151_ENABLE) && EGUI_DRIVER_TOUCH_GT1151_ENABLE
...
/* Driver: del */
static void gt1151_del(egui_hal_touch_driver_t *self)
{
    if (self->set_rst)
    {
        self->set_rst(0);
...
/* Driver: read */
static int gt1151_read(egui_hal_touch_driver_t *self, egui_core_t *core, egui_hal_touch_data_t *data)
{
    EGUI_UNUSED(core);
    uint8_t status;
                                ...
                                uint8_t (*get_int)(void))
{
    ...
    driver->reset = gt1151_reset;
    driver->init = gt1151_init;
    driver->del = gt1151_del;
                            ...
                            uint8_t (*get_int)(void))
{
    ...
    gt1151_setup_driver(storage, io, set_rst, set_int, get_int);
}

#endif /* EGUI_DRIVER_TOUCH_GT1151_ENABLE */
