...
#define EGUI_CONFIG_SCREEN_WIDTH HELLO_VIRTUAL_STAGE_CANVAS_WIDTH
#endif

#ifndef EGUI_CONFIG_SCREEN_HEIGHT
#define EGUI_CONFIG_SCREEN_HEIGHT HELLO_VIRTUAL_STAGE_CANVAS_HEIGHT
#endif

#ifndef EGUI_CONFIG_PFB_WIDTH
#define EGUI_CONFIG_PFB_WIDTH ((EGUI_CONFIG_SCREEN_WIDTH + 7) / 8)
#endif

#ifndef EGUI_CONFIG_PFB_HEIGHT
#define EGUI_CONFIG_PFB_HEIGHT ((EGUI_CONFIG_SCREEN_HEIGHT + 7) / 8)
#endif
