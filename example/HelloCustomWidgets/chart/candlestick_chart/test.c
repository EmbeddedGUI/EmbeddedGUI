...
static void apply_compact_state(uint8_t index, int is_active)
{
    ...
    if (is_active)
    {
        ...
        egui_view_candlestick_chart_set_palette(
                EGUI_VIEW_OF(&candle_compact),
                EGUI_COLOR_HEX(CANDLE_COMPACT_ACTIVE_BG),
                EGUI_COLOR_HEX(CANDLE_COMPACT_ACTIVE_BORDER),
                EGUI_COLOR_HEX(CANDLE_COMPACT_ACTIVE_RISE),
                EGUI_COLOR_HEX(CANDLE_COMPACT_ACTIVE_FALL),
                EGUI_COLOR_HEX(CANDLE_COMPACT_ACTIVE_NEUTRAL),
                EGUI_COLOR_HEX(CANDLE_COMPACT_ACTIVE_TEXT),
                EGUI_COLOR_HEX(CANDLE_COMPACT_ACTIVE_MUTED));
    }
    else
    {
        ...
        egui_view_candlestick_chart_set_palette(
                EGUI_VIEW_OF(&candle_compact),
                EGUI_COLOR_HEX(CANDLE_COMPACT_IDLE_BG),
                EGUI_COLOR_HEX(CANDLE_COMPACT_IDLE_BORDER),
                EGUI_COLOR_HEX(CANDLE_COMPACT_IDLE_RISE),
                EGUI_COLOR_HEX(CANDLE_COMPACT_IDLE_FALL),
                EGUI_COLOR_HEX(CANDLE_COMPACT_IDLE_NEUTRAL),
                EGUI_COLOR_HEX(CANDLE_COMPACT_IDLE_TEXT),
                EGUI_COLOR_HEX(CANDLE_COMPACT_IDLE_MUTED));
    }
}
...
static void on_primary_click(egui_view_t *self)
{
    ...
    {
        set_status(
                CANDLE_STATUS_TEXT_A,
                EGUI_COLOR_HEX(CANDLE_STATUS_PRIMARY_COLOR),
                EGUI_COLOR_HEX(CANDLE_GUIDE_COLOR),
                EGUI_COLOR_HEX(CANDLE_DIVIDER_PRIMARY));
    }
    else
    {
        set_status(
                CANDLE_STATUS_TEXT_B,
                EGUI_COLOR_HEX(CANDLE_STATUS_DOWN_COLOR),
                EGUI_COLOR_HEX(0xA27783),
                EGUI_COLOR_HEX(CANDLE_DIVIDER_DOWN));
    }
}
...
static void on_compact_click(egui_view_t *self)
{
    ...
    set_status(
            (next == 0) ? CANDLE_STATUS_TEXT_COMPACT_A : CANDLE_STATUS_TEXT_COMPACT_B,
            EGUI_COLOR_HEX(CANDLE_STATUS_COMPACT_COLOR),
...
void test_init_ui(void)
{
    ...
    egui_view_candlestick_chart_set_value_set(
            EGUI_VIEW_OF(&candle_primary), 0, primary_open_a, primary_high_a, primary_low_a, primary_close_a);
    egui_view_candlestick_chart_set_value_set(
            EGUI_VIEW_OF(&candle_primary), 1, primary_open_b, primary_high_b, primary_low_b, primary_close_b);
    egui_view_candlestick_chart_set_current_value_set(EGUI_VIEW_OF(&candle_primary), 0);
    egui_view_candlestick_chart_set_palette(
            EGUI_VIEW_OF(&candle_primary),
            EGUI_COLOR_HEX(CANDLE_PRIMARY_BG),
            EGUI_COLOR_HEX(CANDLE_PRIMARY_BORDER),
            EGUI_COLOR_HEX(CANDLE_PRIMARY_RISE),
            EGUI_COLOR_HEX(CANDLE_PRIMARY_FALL),
            EGUI_COLOR_HEX(CANDLE_PRIMARY_NEUTRAL),
            EGUI_COLOR_HEX(CANDLE_PRIMARY_TEXT),
            EGUI_COLOR_HEX(CANDLE_PRIMARY_MUTED));
    ...
    egui_view_candlestick_chart_set_value_set(
            EGUI_VIEW_OF(&candle_compact), 0, compact_open_a, compact_high_a, compact_low_a, compact_close_a);
    egui_view_candlestick_chart_set_value_set(
            EGUI_VIEW_OF(&candle_compact), 1, compact_open_b, compact_high_b, compact_low_b, compact_close_b);
    ...
    egui_view_candlestick_chart_set_value_set(
            EGUI_VIEW_OF(&candle_locked), 0, compact_open_a, compact_high_a, compact_low_a, compact_close_a);
    ...
    egui_view_candlestick_chart_set_palette(
            EGUI_VIEW_OF(&candle_locked),
            EGUI_COLOR_HEX(CANDLE_LOCKED_BG),
            EGUI_COLOR_HEX(CANDLE_LOCKED_BORDER),
            EGUI_COLOR_HEX(CANDLE_LOCKED_RISE),
            EGUI_COLOR_HEX(CANDLE_LOCKED_FALL),
            EGUI_COLOR_HEX(CANDLE_LOCKED_NEUTRAL),
            EGUI_COLOR_HEX(CANDLE_LOCKED_TEXT),
            EGUI_COLOR_HEX(CANDLE_LOCKED_MUTED));
