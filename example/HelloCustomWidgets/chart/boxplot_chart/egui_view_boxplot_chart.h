#ifndef _EGUI_VIEW_BOXPLOT_CHART_H_
#define _EGUI_VIEW_BOXPLOT_CHART_H_
...
#define EGUI_VIEW_BOXPLOT_CHART_MAX_ITEMS      6
#define EGUI_VIEW_BOXPLOT_CHART_MAX_VALUE_SETS 3

typedef struct egui_view_boxplot_chart egui_view_boxplot_chart_t;
struct egui_view_boxplot_chart
{
    egui_view_t base;
    const char **item_labels;
    const uint8_t *min_sets[EGUI_VIEW_BOXPLOT_CHART_MAX_VALUE_SETS];
    const uint8_t *q1_sets[EGUI_VIEW_BOXPLOT_CHART_MAX_VALUE_SETS];
    const uint8_t *median_sets[EGUI_VIEW_BOXPLOT_CHART_MAX_VALUE_SETS];
    const uint8_t *q3_sets[EGUI_VIEW_BOXPLOT_CHART_MAX_VALUE_SETS];
    const uint8_t *max_sets[EGUI_VIEW_BOXPLOT_CHART_MAX_VALUE_SETS];
...
#endif /* _EGUI_VIEW_BOXPLOT_CHART_H_ */
