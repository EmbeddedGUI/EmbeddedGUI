...
static const uint8_t primary_values_a[] = {18, 42, 65, 72, 24, 38, 58, 84, 12, 34, 77, 91, 8, 29, 51, 69};
static const uint8_t primary_values_b[] = {62, 28, 19, 44, 75, 41, 33, 56, 88, 63, 47, 31, 93, 71, 52, 26};
static const uint8_t compact_values_a[] = {15, 44, 72, 28, 58, 83, 11, 37, 65};
static const uint8_t compact_values_b[] = {63, 35, 18, 79, 52, 29, 91, 68, 46};
...
static void apply_compact_state(uint8_t index, int is_active)
{
    ...
    if (is_active)
    {
        ...
        egui_view_heatmap_chart_set_palette(EGUI_VIEW_OF(&heatmap_compact), EGUI_COLOR_HEX(HEATMAP_COMPACT_ACTIVE_BG),
                                            EGUI_COLOR_HEX(HEATMAP_COMPACT_ACTIVE_BORDER), EGUI_COLOR_HEX(HEATMAP_COMPACT_ACTIVE_COLD),
                                            EGUI_COLOR_HEX(HEATMAP_COMPACT_ACTIVE_HOT), EGUI_COLOR_HEX(HEATMAP_COMPACT_ACTIVE_TEXT),
    ...
    else
    {
        ...
        egui_view_heatmap_chart_set_palette(EGUI_VIEW_OF(&heatmap_compact), EGUI_COLOR_HEX(HEATMAP_COMPACT_IDLE_BG),
                                            EGUI_COLOR_HEX(HEATMAP_COMPACT_IDLE_BORDER), EGUI_COLOR_HEX(HEATMAP_COMPACT_IDLE_COLD),
                                            EGUI_COLOR_HEX(HEATMAP_COMPACT_IDLE_HOT), EGUI_COLOR_HEX(HEATMAP_COMPACT_IDLE_TEXT),
...
static void on_primary_click(egui_view_t *self)
{
    ...
    set_status((next == 0) ? HEATMAP_STATUS_TEXT_A : HEATMAP_STATUS_TEXT_B, EGUI_COLOR_HEX(HEATMAP_STATUS_PRIMARY_COLOR), EGUI_COLOR_HEX(HEATMAP_GUIDE_COLOR),
...
static void on_compact_click(egui_view_t *self)
{
    ...
    set_status((next == 0) ? HEATMAP_STATUS_TEXT_COMPACT_A : HEATMAP_STATUS_TEXT_COMPACT_B, EGUI_COLOR_HEX(HEATMAP_STATUS_COMPACT_COLOR),
               EGUI_COLOR_HEX(0xA07A42), EGUI_COLOR_HEX(HEATMAP_DIVIDER_COLOR_COMPACT));
}
...
void test_init_ui(void)
{
    ...
    egui_view_heatmap_chart_set_palette(EGUI_VIEW_OF(&heatmap_primary), EGUI_COLOR_HEX(HEATMAP_PRIMARY_BG), EGUI_COLOR_HEX(HEATMAP_PRIMARY_BORDER),
                                        EGUI_COLOR_HEX(HEATMAP_PRIMARY_COLD), EGUI_COLOR_HEX(HEATMAP_PRIMARY_HOT), EGUI_COLOR_HEX(HEATMAP_PRIMARY_TEXT),
    ...
    egui_view_heatmap_chart_set_palette(EGUI_VIEW_OF(&heatmap_locked), EGUI_COLOR_HEX(HEATMAP_LOCKED_BG), EGUI_COLOR_HEX(HEATMAP_LOCKED_BORDER),
                                        EGUI_COLOR_HEX(HEATMAP_LOCKED_COLD), EGUI_COLOR_HEX(HEATMAP_LOCKED_HOT), EGUI_COLOR_HEX(HEATMAP_LOCKED_TEXT),
