...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    static const egui_sim_action_t actions[] = {
            EGUI_SIM_WAIT(400), EGUI_SIM_CLICK(200, 138, 700),
            EGUI_SIM_WAIT(300), EGUI_SIM_CLICK(40, 138, 700),
            EGUI_SIM_WAIT(300), EGUI_SIM_CLICK(120, 134, 700),
            EGUI_SIM_WAIT(300), EGUI_SIM_CLICK(200, 138, 700),
