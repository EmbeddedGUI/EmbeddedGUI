...
static void apply_compact_state(uint8_t index, uint8_t is_active)
{
    ...
    if (is_active)
    {
        ...
        egui_view_avatar_stack_set_palette(EGUI_VIEW_OF(&stack_compact), EGUI_COLOR_HEX(0x23160A), EGUI_COLOR_HEX(0x8B5E1A), EGUI_COLOR_HEX(0xFDE68A),
    ...
    else
    {
        ...
        egui_view_avatar_stack_set_palette(EGUI_VIEW_OF(&stack_compact), EGUI_COLOR_HEX(0x121A28), EGUI_COLOR_HEX(0x3D5068), EGUI_COLOR_HEX(0xCBD5E1),
...
static void on_primary_click(egui_view_t *self)
{
    ...
    set_status((next == 0) ? AVATAR_STATUS_TEXT_A : AVATAR_STATUS_TEXT_B, EGUI_COLOR_HEX(AVATAR_STATUS_PRIMARY_COLOR), EGUI_COLOR_HEX(AVATAR_GUIDE_COLOR),
               EGUI_COLOR_HEX(AVATAR_DIVIDER_PRIMARY));
}
...
static void on_compact_click(egui_view_t *self)
{
    ...
    set_status((next == 0) ? AVATAR_STATUS_TEXT_COMPACT_A : AVATAR_STATUS_TEXT_COMPACT_B, EGUI_COLOR_HEX(AVATAR_STATUS_COMPACT_COLOR), EGUI_COLOR_HEX(0xA07A42),
               EGUI_COLOR_HEX(AVATAR_DIVIDER_COMPACT));
}
...
void test_init_ui(void)
{
    ...
    egui_view_avatar_stack_set_palette(EGUI_VIEW_OF(&stack_primary), EGUI_COLOR_HEX(0x0F1728), EGUI_COLOR_HEX(0x536379), EGUI_COLOR_HEX(0xE2E8F0),
    ...
    egui_view_avatar_stack_set_palette(EGUI_VIEW_OF(&stack_locked), EGUI_COLOR_HEX(0x0E1522), EGUI_COLOR_HEX(0x46566B), EGUI_COLOR_HEX(0xCBD5E1),
