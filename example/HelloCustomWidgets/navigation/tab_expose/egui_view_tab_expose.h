#ifndef _EGUI_VIEW_TAB_EXPOSE_H_
#define _EGUI_VIEW_TAB_EXPOSE_H_
...
#define EGUI_VIEW_TAB_EXPOSE_MAX_SNAPSHOTS 6

typedef struct egui_view_tab_expose_snapshot egui_view_tab_expose_snapshot_t;
struct egui_view_tab_expose_snapshot
{
    const char *title;
    const char *status;
    const char *summary;
    const char *footer;
    uint8_t active_tab;
    uint8_t preview_mask;
    uint8_t accent_mode;
};

typedef struct egui_view_tab_expose egui_view_tab_expose_t;
struct egui_view_tab_expose
{
    egui_view_t base;
    const egui_view_tab_expose_snapshot_t *snapshots;
