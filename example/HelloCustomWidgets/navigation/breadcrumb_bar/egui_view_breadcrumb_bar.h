#ifndef _EGUI_VIEW_BREADCRUMB_BAR_H_
#define _EGUI_VIEW_BREADCRUMB_BAR_H_
...
#define EGUI_VIEW_BREADCRUMB_BAR_MAX_ITEMS     6
#define EGUI_VIEW_BREADCRUMB_BAR_MAX_SNAPSHOTS 4

typedef struct egui_view_breadcrumb_bar_snapshot egui_view_breadcrumb_bar_snapshot_t;
struct egui_view_breadcrumb_bar_snapshot
{
    const char *title;
    const char **items;
    uint8_t item_count;
...
typedef struct egui_view_breadcrumb_bar egui_view_breadcrumb_bar_t;
struct egui_view_breadcrumb_bar
{
    egui_view_t base;
    const egui_view_breadcrumb_bar_snapshot_t *snapshots;
...
#endif /* _EGUI_VIEW_BREADCRUMB_BAR_H_ */
