#ifndef _EGUI_VIEW_BREADCRUMB_TRAIL_H_
#define _EGUI_VIEW_BREADCRUMB_TRAIL_H_
...
#define EGUI_VIEW_BREADCRUMB_TRAIL_MAX_ITEMS 5
#define EGUI_VIEW_BREADCRUMB_TRAIL_MAX_SNAPSHOTS 3

typedef struct egui_view_breadcrumb_trail_snapshot egui_view_breadcrumb_trail_snapshot_t;
struct egui_view_breadcrumb_trail_snapshot
{
    const char *title;
    const char **items;
    uint8_t item_count;
...
typedef struct egui_view_breadcrumb_trail egui_view_breadcrumb_trail_t;
struct egui_view_breadcrumb_trail
{
    egui_view_t base;
    const egui_view_breadcrumb_trail_snapshot_t *snapshots;
...
#endif /* _EGUI_VIEW_BREADCRUMB_TRAIL_H_ */
