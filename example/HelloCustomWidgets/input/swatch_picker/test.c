...
static const egui_color_t primary_colors_a[] = {
...
static const egui_color_t primary_colors_b[] = {
        EGUI_COLOR_HEX(0x67E8F9), EGUI_COLOR_HEX(0xFBBF24), EGUI_COLOR_HEX(0xF97316),
...
static const egui_color_t compact_colors_a[] = {
        EGUI_COLOR_HEX(0x60A5FA), EGUI_COLOR_HEX(0xF59E0B), EGUI_COLOR_HEX(0xFB7185),
        EGUI_COLOR_HEX(0x34D399), EGUI_COLOR_HEX(0xA78BFA), EGUI_COLOR_HEX(0xCBD5E1)};
static const char *compact_labels_b[] = {"G", "H", "I", "J", "K", "L"};
static const egui_color_t compact_colors_b[] = {
        EGUI_COLOR_HEX(0x22D3EE), EGUI_COLOR_HEX(0xF97316), EGUI_COLOR_HEX(0xE879F9),
...
static void apply_compact_state(uint8_t index, uint8_t is_active)
{
    ...
    if (is_active)
    {
        ...
        egui_view_swatch_picker_set_palette(
                EGUI_VIEW_OF(&picker_compact),
