...
static void uicode_disp0_init_ui(egui_core_t *core)
{
    ...
    // Green label
    egui_view_label_init(EGUI_VIEW_OF(&label_green), core);
    ...
    // Blue label
    egui_view_label_init(EGUI_VIEW_OF(&label_blue), core);
    ...
    // Red Top button
    egui_view_button_init(EGUI_VIEW_OF(&btn_red_top), core);
    ...
    // Green Top button
    egui_view_button_init(EGUI_VIEW_OF(&btn_green_top), core);
    ...
    // Blue Top button
    egui_view_button_init(EGUI_VIEW_OF(&btn_blue_top), core);
