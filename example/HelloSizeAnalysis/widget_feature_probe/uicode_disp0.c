...
{
    egui_view_slider_init_with_params(EGUI_VIEW_OF(&probe_slider), s_core, &probe_slider_params);
    egui_view_slider_set_value(EGUI_VIEW_OF(&probe_slider), 60);
}

EGUI_SIZE_PROBE_FUNC widget_probe_switch(void)
{
    egui_view_switch_init_with_params(EGUI_VIEW_OF(&probe_switch), s_core, &probe_switch_params);
    egui_view_switch_set_checked(EGUI_VIEW_OF(&probe_switch), 1);
}

EGUI_SIZE_PROBE_FUNC widget_probe_page_indicator(void)
{
    egui_view_page_indicator_init_with_params(EGUI_VIEW_OF(&probe_page_indicator), s_core, &probe_page_indicator_params);
...
{
    egui_view_toggle_button_init_with_params(EGUI_VIEW_OF(&probe_toggle_button), s_core, &probe_toggle_button_params);
...
{
    egui_view_notification_badge_init_with_params(EGUI_VIEW_OF(&probe_notification_badge), s_core, &probe_notification_badge_params);
...
{
    egui_view_button_init_with_params(EGUI_VIEW_OF(&probe_button), s_core, &probe_button_params);
}

EGUI_SIZE_PROBE_FUNC widget_probe_image_button(void)
{
    egui_view_image_button_init_with_params(EGUI_VIEW_OF(&probe_image_button), s_core, &probe_image_button_params);
...
{
    egui_view_circular_progress_bar_init_with_params(EGUI_VIEW_OF(&probe_cpb), s_core, &probe_cpb_params);
    egui_view_circular_progress_bar_set_process(EGUI_VIEW_OF(&probe_cpb), 70);
}

EGUI_SIZE_PROBE_FUNC widget_probe_gauge(void)
{
    egui_view_gauge_init_with_params(EGUI_VIEW_OF(&probe_gauge), s_core, &probe_gauge_params);
    egui_view_gauge_set_value(EGUI_VIEW_OF(&probe_gauge), 75);
}

EGUI_SIZE_PROBE_FUNC widget_probe_activity_ring(void)
{
    egui_view_activity_ring_init_with_params(EGUI_VIEW_OF(&probe_activity_ring), s_core, &probe_activity_ring_params);
...
{
    egui_view_analog_clock_init_with_params(EGUI_VIEW_OF(&probe_analog_clock), s_core, &probe_analog_clock_params);
...
{
    egui_view_line_init_with_params(EGUI_VIEW_OF(&probe_line), s_core, &probe_line_params);
...
{
    egui_view_chart_line_init_with_params(EGUI_VIEW_OF(&probe_chart_line), s_core, &probe_chart_line_params);
...
{
    egui_view_chart_pie_init_with_params(EGUI_VIEW_OF(&probe_chart_pie), s_core, &probe_chart_pie_params);
