...
EGUI_VIEW_LINEARLAYOUT_PARAMS_INIT(layout_1_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, EGUI_CONFIG_SCREEN_HEIGHT, EGUI_ALIGN_CENTER);
...
EGUI_SIZE_PROBE_FUNC uicode_size_probe_link_hq_paths(void)
{
    ...
    egui_canvas_draw_line_hq(canvas, 0, 0, 16, 16, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
    egui_canvas_draw_line_round_cap_hq(canvas, 0, 0, 16, 16, 4, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
    egui_canvas_draw_polyline_hq(canvas, probe_polyline, 3, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
    egui_canvas_draw_polyline_round_cap_hq(canvas, probe_polyline, 3, 4, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
#endif

#if defined(EGUI_SIZE_PROBE_LINK_CIRCLE_HQ)
    egui_canvas_draw_circle_hq(canvas, 16, 16, 8, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
    egui_canvas_draw_circle_fill_hq(canvas, 16, 16, 8, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
#endif

#if defined(EGUI_SIZE_PROBE_LINK_ARC_HQ)
    egui_canvas_draw_arc_hq(canvas, 16, 16, 10, 0, 90, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
    egui_canvas_draw_arc_fill_hq(canvas, 16, 16, 10, 0, 90, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
#endif

#if defined(EGUI_SIZE_PROBE_LINK_ARC_ROUND_CAP_HQ)
    egui_canvas_draw_arc_round_cap_hq(canvas, 16, 16, 12, 0, 120, 4, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
#endif
}
#endif
