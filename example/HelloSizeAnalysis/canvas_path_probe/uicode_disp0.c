...
{
    egui_canvas_draw_rectangle(canvas, 0, 0, 12, 8, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_rect_fill(void)
{
    egui_canvas_draw_rectangle_fill(canvas, 1, 1, 10, 6, EGUI_COLOR_GREEN, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_round_rect_stroke(void)
{
    egui_canvas_draw_round_rectangle(canvas, 0, 0, 16, 10, 4, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_round_rect_fill(void)
{
    egui_canvas_draw_round_rectangle_fill(canvas, 0, 0, 16, 10, 4, EGUI_COLOR_GREEN, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_triangle_stroke(void)
{
    egui_canvas_draw_triangle(canvas, 0, 10, 8, 0, 16, 10, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_triangle_fill(void)
{
    egui_canvas_draw_triangle_fill(canvas, 0, 12, 8, 2, 16, 12, EGUI_COLOR_BLUE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_circle_basic_stroke(void)
{
    egui_canvas_draw_circle_basic(canvas, 12, 12, 8, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_circle_basic_fill(void)
{
    egui_canvas_draw_circle_fill_basic(canvas, 12, 12, 8, EGUI_COLOR_RED, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_arc_basic_stroke(void)
{
    egui_canvas_draw_arc_basic(canvas, 12, 12, 8, 0, 120, 2, EGUI_COLOR_GREEN, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_arc_basic_fill(void)
{
    egui_canvas_draw_arc_fill_basic(canvas, 12, 12, 8, 0, 120, EGUI_COLOR_BLUE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_line(void)
{
    egui_canvas_draw_line(canvas, 0, 0, 18, 8, 2, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_polyline(void)
{
    egui_canvas_draw_polyline(canvas, probe_polyline_points, 3, 2, EGUI_COLOR_BLUE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_gradient_rect(void)
{
    egui_canvas_draw_rectangle_fill_gradient(canvas, 0, 0, 18, 10, &probe_linear_gradient);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_gradient_round_rect(void)
{
    egui_canvas_draw_round_rectangle_fill_gradient(canvas, 0, 0, 18, 10, 4, &probe_linear_gradient);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_gradient_circle(void)
{
    egui_canvas_draw_circle_fill_gradient(canvas, 10, 10, 8, &probe_linear_gradient);
}
...
EGUI_SIZE_PROBE_FUNC canvas_probe_mask_circle(void)
{
    ...
    egui_canvas_set_mask(canvas, (egui_mask_t *)&mask);
    egui_canvas_draw_rectangle_fill(canvas, 0, 0, 20, 20, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
...
EGUI_SIZE_PROBE_FUNC canvas_probe_mask_round_rect(void)
{
    ...
    egui_canvas_set_mask(canvas, (egui_mask_t *)&mask);
    egui_canvas_draw_rectangle_fill(canvas, 0, 0, 20, 20, EGUI_COLOR_GREEN, EGUI_ALPHA_100);
    egui_canvas_clear_mask(canvas);
#endif
}
...
EGUI_SIZE_PROBE_FUNC canvas_probe_mask_image(void)
{
    ...
    egui_canvas_set_mask(canvas, (egui_mask_t *)&mask);
    egui_canvas_draw_rectangle_fill(canvas, 0, 0, 4, 4, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
    egui_canvas_clear_mask(canvas);
#endif
}
...
{
    egui_canvas_draw_image(canvas, (const egui_image_t *)&probe_image_std, 0, 0);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_image_resize(void)
{
    egui_canvas_draw_image_resize(canvas, (const egui_image_t *)&probe_image_std, 0, 0, 4, 4);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_image_tint(void)
{
    egui_canvas_draw_image_color(canvas, (const egui_image_t *)&probe_image_std, 0, 0, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_image_rotate(void)
{
    egui_canvas_draw_image_rotate(canvas, (const egui_image_t *)&probe_image_std, 0, 0, 30);
}

EGUI_SIZE_PROBE_FUNC canvas_probe_text_rotate(void)
{
    egui_canvas_draw_text_rotate(canvas, (const egui_font_t *)EGUI_CONFIG_FONT_DEFAULT, "A", 0, 0, 30, EGUI_COLOR_WHITE, EGUI_ALPHA_100);
}
