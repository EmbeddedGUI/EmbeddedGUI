...
// View params
EGUI_VIEW_LABEL_PARAMS_INIT(label_vertical_params, 0, 0, LABEL_WIDTH, EGUI_CONFIG_SCREEN_HEIGHT, "Vertical", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_WHITE,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(label_horizontal_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, LABEL_HEIGHT, "Horizontal", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_WHITE,
                            EGUI_ALPHA_100);
...
static void uicode_disp0_init_ui(egui_core_t *core)
{
    // Init all views
    // label_vertical
    egui_view_label_init_with_params(EGUI_VIEW_OF(&label_vertical), core, &label_vertical_params);

    // label_horizontal
    egui_view_label_init_with_params(EGUI_VIEW_OF(&label_horizontal), core, &label_horizontal_params);
