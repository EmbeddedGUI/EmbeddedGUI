...
#define EGUI_CONFIG_SCREEN_WIDTH HELLO_STYLE_DEMO_CANVAS_WIDTH
#endif

#ifndef EGUI_CONFIG_SCREEN_HEIGHT
#define EGUI_CONFIG_SCREEN_HEIGHT HELLO_STYLE_DEMO_CANVAS_HEIGHT
#endif

#define EGUI_CONFIG_PFB_WIDTH  (EGUI_CONFIG_SCREEN_WIDTH / 4)
#define EGUI_CONFIG_PFB_HEIGHT (EGUI_CONFIG_SCREEN_HEIGHT / 4)
