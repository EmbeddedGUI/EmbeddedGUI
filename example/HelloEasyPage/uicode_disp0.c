...
void uicode_switch_page(int page_index)
{
    ...
    egui_toast_show_info((egui_toast_t *)&toast, toast_str);
    ...
    case 1:
        ...
        break;
    case 2:
        egui_page_2_init((egui_page_base_t *)&g_page_array.page_2, core);
...
int uicode_start_next_page(void)
{
    ...
    {
        egui_toast_show_info((egui_toast_t *)&toast, "No more next page");
        return -1;
    }
...
int uicode_start_prev_page(void)
{
    ...
    if (page_index < 0)
    {
        egui_toast_show_info((egui_toast_t *)&toast, "No more previous page");
        return -1;
    }
