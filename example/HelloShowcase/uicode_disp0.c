...
{
    egui_view_label_init(EGUI_VIEW_OF(lbl), s_core);
...
static void uicode_disp0_init_ui(egui_core_t *core)
{
    ...
    egui_view_button_init(EGUI_VIEW_OF(&btn_lang), core);
    ...
    egui_view_button_init(EGUI_VIEW_OF(&btn_theme), core);
    ...
    egui_view_init(&panel_basic, core);
    ...
    egui_view_init(&panel_toggle, core);
    ...
    egui_view_init(&panel_progress, core);
    ...
    egui_view_init(&panel_canvas, core);
    ...
    egui_view_init(&panel_slider, core);
    ...
    egui_view_init(&panel_chart, core);
    ...
    egui_view_init(&panel_time, core);
    ...
    egui_view_init(&panel_special, core);
    ...
    egui_view_init(&panel_data, core);
    ...
    egui_view_button_init(EGUI_VIEW_OF(&wg_button), core);
    ...
    egui_view_textblock_init(EGUI_VIEW_OF(&wg_textblock), core);
    ...
    egui_view_dynamic_label_init(EGUI_VIEW_OF(&wg_dynlabel), core);
    ...
    egui_view_card_init(EGUI_VIEW_OF(&wg_card), core);
    egui_view_set_position(EGUI_VIEW_OF(&wg_card), 16, 192);
    egui_view_set_size(EGUI_VIEW_OF(&wg_card), 130, 52);
    egui_view_label_init(EGUI_VIEW_OF(&wg_card_child), core);
    ...
    egui_view_textinput_init(EGUI_VIEW_OF(&wg_textinput), core);
    ...
    egui_view_checkbox_init(EGUI_VIEW_OF(&wg_checkbox), core);
    ...
    egui_view_radio_button_init(EGUI_VIEW_OF(&wg_radio2), core);
    ...
    egui_view_toggle_button_init(EGUI_VIEW_OF(&wg_togbtn), core);
    ...
    egui_view_led_init(EGUI_VIEW_OF(&wg_led), core);
    ...
    egui_view_notification_badge_init(EGUI_VIEW_OF(&wg_badge), core);
    ...
    egui_view_circular_progress_bar_init(EGUI_VIEW_OF(&wg_cpbar), core);
    ...
    egui_view_gauge_init(EGUI_VIEW_OF(&wg_gauge), core);
    ...
    egui_view_activity_ring_init(EGUI_VIEW_OF(&wg_actring), core);
    ...
    egui_view_page_indicator_init(EGUI_VIEW_OF(&wg_pagind), core);
    ...
    egui_view_init(&wg_cv_gradient, core);
    ...
    egui_view_init(&wg_cv_shadow, core);
    ...
    egui_view_init(&wg_cv_border1, core);
    ...
    egui_view_init(&wg_cv_border2, core);
    ...
    egui_view_init(&wg_cv_alpha1, core);
    ...
    egui_view_init(&wg_cv_alpha2, core);
    ...
    egui_view_line_init(EGUI_VIEW_OF(&wg_cv_hqline), core);
    ...
    egui_view_arc_slider_init(EGUI_VIEW_OF(&wg_arcslider), core);
    ...
    egui_view_number_picker_init(EGUI_VIEW_OF(&wg_numpick), core);
    ...
    egui_view_spinner_init(EGUI_VIEW_OF(&wg_spinner), core);
...

    {
        ...
        egui_view_scale_init_with_params(EGUI_VIEW_OF(&wg_scale), core, &sp);
...

    {
        ...
        egui_view_chart_line_init_with_params(EGUI_VIEW_OF(&wg_chart_line), core, &p);
...

    {
        ...
        egui_view_chart_bar_init_with_params(EGUI_VIEW_OF(&wg_chart_bar), core, &p);
...

    {
        ...
        egui_view_chart_pie_init_with_params(EGUI_VIEW_OF(&wg_chart_pie), core, &p);
...

    {
        ...
        egui_view_chart_scatter_init_with_params(EGUI_VIEW_OF(&wg_chart_scatter), core, &p);
...

    {
        ...
        egui_view_analog_clock_init_with_params(EGUI_VIEW_OF(&wg_aclock), core, &p);
    ...
    egui_view_digital_clock_init(EGUI_VIEW_OF(&wg_dclock), core);
    ...
    egui_view_stopwatch_init(EGUI_VIEW_OF(&wg_stopwatch), core);
...

    {
        ...
        egui_view_compass_init_with_params(EGUI_VIEW_OF(&wg_compass), core, &p);
    }
    egui_view_group_add_child(EGUI_VIEW_OF(&root), EGUI_VIEW_OF(&wg_compass));

    {
        EGUI_VIEW_HEART_RATE_PARAMS_INIT(p, 400, 762, 110, 68, 72);
        egui_view_heart_rate_init_with_params(EGUI_VIEW_OF(&wg_heartrate), core, &p);
    }
...

    {
        ...
        egui_view_line_init_with_params(EGUI_VIEW_OF(&wg_line), core, &lp);
...

    {
        ...
        egui_view_divider_init_with_params(EGUI_VIEW_OF(&wg_divider), core, &dp);
    }
...

    {
        ...
        egui_view_table_init_with_params(EGUI_VIEW_OF(&wg_table), core, &tp);
...

    {
        ...
        egui_view_list_init_with_params(EGUI_VIEW_OF(&wg_list), core, &lp);
    ...
    egui_view_spangroup_init(EGUI_VIEW_OF(&wg_spangrp), core);
...

    {
        ...
        egui_view_window_init_with_params(EGUI_VIEW_OF(&wg_window), core, &wp);
        egui_view_label_init(EGUI_VIEW_OF(&wg_window_lbl), core);
    ...
    egui_view_start_timer(EGUI_VIEW_OF(&root), &anim_timer, 100, 100);
#endif
