...
#include "test_progress_bar_get_control_color.h"
...
{
    egui_color_t got = egui_view_progress_bar_get_control_color(NULL);
    EGUI_TEST_ASSERT_EQUAL_INT(0, (int)got.full);
}

void test_progress_bar_get_control_color_run(void)
{
    EGUI_TEST_SUITE_BEGIN(progress_bar_get_control_color);

    EGUI_TEST_RUN(test_progress_bar_get_control_color_default);
    EGUI_TEST_RUN(test_progress_bar_get_control_color_after_set);
    EGUI_TEST_RUN(test_progress_bar_get_control_color_update);
    EGUI_TEST_RUN(test_progress_bar_get_control_color_null_self);
