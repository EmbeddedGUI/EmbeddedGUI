...
#include "test_checkbox_get_check_color.h"
...
/* Default check_color after init is EGUI_THEME_TEXT. */
...
static void test_checkbox_get_check_color_after_set(void)
{
    egui_color_t c;
    c.full = 0xAABBCCu;
    setup();
...
static void test_checkbox_get_check_color_update(void)
{
    egui_color_t c1, c2;
    c1.full = 0xAABBCCu;
    c2.full = 0xDDEEFFu;
...
static void test_checkbox_get_check_color_null_self(void)
{
    egui_color_t got = egui_view_checkbox_get_check_color(NULL);
    EGUI_TEST_ASSERT_EQUAL_INT(0, (int)got.full);
}

void test_checkbox_get_check_color_run(void)
{
    EGUI_TEST_SUITE_BEGIN(checkbox_get_check_color);

    EGUI_TEST_RUN(test_checkbox_get_check_color_default);
    EGUI_TEST_RUN(test_checkbox_get_check_color_after_set);
    EGUI_TEST_RUN(test_checkbox_get_check_color_update);
    EGUI_TEST_RUN(test_checkbox_get_check_color_null_self);
