...
{
    setup();
    EGUI_TEST_ASSERT_EQUAL_INT((int)EGUI_COLOR_DARK_GREY.full, (int)egui_view_arc_slider_get_track_color(EGUI_VIEW_OF(&s_arc)).full);
}
...
static void test_arc_slider_get_track_color_after_set(void)
{
    ...
    setup();
    s_arc.track_color = c;
    EGUI_TEST_ASSERT_EQUAL_INT((int)c.full, (int)egui_view_arc_slider_get_track_color(EGUI_VIEW_OF(&s_arc)).full);
}
...
static void test_arc_slider_get_track_color_update(void)
{
    ...
    EGUI_TEST_ASSERT_EQUAL_INT((int)c1.full, (int)egui_view_arc_slider_get_track_color(EGUI_VIEW_OF(&s_arc)).full);
    s_arc.track_color = c2;
    EGUI_TEST_ASSERT_EQUAL_INT((int)c2.full, (int)egui_view_arc_slider_get_track_color(EGUI_VIEW_OF(&s_arc)).full);
}
