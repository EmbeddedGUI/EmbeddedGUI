...
{
    setup();
    EGUI_TEST_ASSERT_EQUAL_INT((int)EGUI_THEME_TEXT_PRIMARY.full, (int)egui_view_roller_get_selected_text_color(EGUI_VIEW_OF(&s_roller)).full);
}
...
static void test_roller_get_selected_text_color_after_set(void)
{
    ...
    EGUI_TEST_ASSERT_EQUAL_INT((int)c.full, (int)egui_view_roller_get_selected_text_color(EGUI_VIEW_OF(&s_roller)).full);
}
...
static void test_roller_get_selected_text_color_update(void)
{
    ...
    EGUI_TEST_ASSERT_EQUAL_INT((int)c1.full, (int)egui_view_roller_get_selected_text_color(EGUI_VIEW_OF(&s_roller)).full);
    s_roller.selected_text_color = c2;
    EGUI_TEST_ASSERT_EQUAL_INT((int)c2.full, (int)egui_view_roller_get_selected_text_color(EGUI_VIEW_OF(&s_roller)).full);
}
