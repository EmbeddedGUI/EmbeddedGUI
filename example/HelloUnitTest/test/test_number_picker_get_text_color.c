...
#include "test_number_picker_get_text_color.h"
...
static void test_number_picker_get_text_color_after_set(void)
{
    egui_color_t c;
    c.full = 0x112233u;
    setup();
...
static void test_number_picker_get_text_color_update(void)
{
    egui_color_t c1, c2;
    c1.full = 0x112233u;
    c2.full = 0x445566u;
...
static void test_number_picker_get_text_color_null_self(void)
{
    egui_color_t got = egui_view_number_picker_get_text_color(NULL);
    EGUI_TEST_ASSERT_EQUAL_INT(0, (int)got.full);
}

void test_number_picker_get_text_color_run(void)
{
    EGUI_TEST_SUITE_BEGIN(number_picker_get_text_color);

    EGUI_TEST_RUN(test_number_picker_get_text_color_default);
    EGUI_TEST_RUN(test_number_picker_get_text_color_after_set);
    EGUI_TEST_RUN(test_number_picker_get_text_color_update);
    EGUI_TEST_RUN(test_number_picker_get_text_color_null_self);
