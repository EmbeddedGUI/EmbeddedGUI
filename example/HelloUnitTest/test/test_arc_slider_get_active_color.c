...
{
    setup();
    EGUI_TEST_ASSERT_EQUAL_INT((int)EGUI_COLOR_BLUE.full, (int)egui_view_arc_slider_get_active_color(EGUI_VIEW_OF(&s_arc)).full);
}
...
static void test_arc_slider_get_active_color_after_set(void)
{
    ...
    EGUI_TEST_ASSERT_EQUAL_INT((int)c.full, (int)egui_view_arc_slider_get_active_color(EGUI_VIEW_OF(&s_arc)).full);
}
...
static void test_arc_slider_get_active_color_update(void)
{
    ...
    EGUI_TEST_ASSERT_EQUAL_INT((int)c1.full, (int)egui_view_arc_slider_get_active_color(EGUI_VIEW_OF(&s_arc)).full);
    s_arc.active_color = c2;
    EGUI_TEST_ASSERT_EQUAL_INT((int)c2.full, (int)egui_view_arc_slider_get_active_color(EGUI_VIEW_OF(&s_arc)).full);
}
