# HelloPerformance Text Transform Heap Override 保留记录
...
- `2026-03-30` 在新的 shipped 基线上重新打开这项：
  - `3072 -> 2560`
...
- 保持 `EGUI_CONFIG_TEXT_TRANSFORM_VISIBLE_ALPHA8_MAX_BYTES=2560`
- 保留 `#ifndef` 外部覆盖入口，继续作为后续 rotated-text heap/perf A/B 的测量入口
