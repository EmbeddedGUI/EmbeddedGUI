...
#define TEST_ITEM_HEIGHT 150

// views in root
static egui_view_scroll_t test_scroll_view;
...
// View params
EGUI_VIEW_SCROLL_PARAMS_INIT(test_scroll_view_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, EGUI_CONFIG_SCREEN_HEIGHT);
EGUI_VIEW_LABEL_PARAMS_INIT(scroll_label_1_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, "Item 1", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_BLACK,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(scroll_label_2_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, "Item 2", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_BLACK,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(scroll_label_3_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, "Item 3", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_WHITE,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(scroll_button_1_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, NULL, EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_BLACK,
                            EGUI_ALPHA_100);
...
egui_view_t *uicode_disp0_init_scroll(egui_core_t *core)
{
    // Init all views
    // test_view
    egui_view_scroll_init_with_params(EGUI_VIEW_OF(&test_scroll_view), core, &test_scroll_view_params);

    // label_1
    egui_view_label_init_with_params(EGUI_VIEW_OF(&label_1), core, &scroll_label_1_params);

    // label_2
    egui_view_label_init_with_params(EGUI_VIEW_OF(&label_2), core, &scroll_label_2_params);

    // label_3
    egui_view_label_init_with_params(EGUI_VIEW_OF(&label_3), core, &scroll_label_3_params);

    // button_1
    egui_view_button_init_with_params(EGUI_VIEW_OF(&button_1), core, &scroll_button_1_params);
