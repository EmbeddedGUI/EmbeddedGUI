...
#define TEST_ITEM_HEIGHT EGUI_CONFIG_SCREEN_HEIGHT
...
// View params
EGUI_VIEW_VIEWPAGE_PARAMS_INIT(test_viewpage_view_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT);
EGUI_VIEW_LABEL_PARAMS_INIT(viewpage_label_1_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, "Item 1", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_BLACK,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(viewpage_label_2_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, "Item 2", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_BLACK,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(viewpage_label_3_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, "Item 3", EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_WHITE,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(viewpage_button_1_params, 0, 0, EGUI_CONFIG_SCREEN_WIDTH, TEST_ITEM_HEIGHT, NULL, EGUI_CONFIG_FONT_DEFAULT, EGUI_COLOR_BLACK,
                            EGUI_ALPHA_100);
