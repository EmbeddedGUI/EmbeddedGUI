...
void test_init_ui(egui_core_t *core)
{
    // Init all views
    // test_mask_1
    egui_view_test_mask_init(EGUI_VIEW_OF(&test_mask_1), core);
    ...
    // test_mask_2
    egui_view_test_mask_init(EGUI_VIEW_OF(&test_mask_2), core);
    ...
    // test_mask_3
    egui_view_test_mask_init(EGUI_VIEW_OF(&test_mask_3), core);
    ...
    // test_mask_4
    egui_view_test_mask_init(EGUI_VIEW_OF(&test_mask_4), core);
    ...
    egui_view_layout_user_root(EGUI_VIEW_OF(&test_mask_1), EGUI_LAYOUT_VERTICAL, EGUI_ALIGN_CENTER);
}
