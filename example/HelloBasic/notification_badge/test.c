...
void test_init_ui(egui_core_t *core)
{
    ...
    egui_view_notification_badge_init_with_params(EGUI_VIEW_OF(&badge_1), core, &badge_1_params);
    ...
    egui_view_notification_badge_init_with_params(EGUI_VIEW_OF(&badge_2), core, &badge_2_params);
    ...
    egui_view_notification_badge_init_with_params(EGUI_VIEW_OF(&badge_3), core, &badge_3_params);
    ...
    egui_view_notification_badge_init_with_params(EGUI_VIEW_OF(&badge_4), core, &badge_4_params);
