...
void test_init_ui(egui_core_t *core)
{
    ...
    egui_view_led_init_with_params(EGUI_VIEW_OF(&led_xs), core, &led_xs_params);
    egui_view_led_set_colors(EGUI_VIEW_OF(&led_xs), EGUI_COLOR_GREEN, EGUI_COLOR_DARK_GREY);

    // Init LED S: red, off
    egui_view_led_init_with_params(EGUI_VIEW_OF(&led_s), core, &led_s_params);
    egui_view_led_set_colors(EGUI_VIEW_OF(&led_s), EGUI_COLOR_RED, EGUI_COLOR_DARK_GREY);

    // Init LED M: yellow, blinking
    egui_view_led_init_with_params(EGUI_VIEW_OF(&led_m), core, &led_m_params);
    ...
    // Init LED L: blue, on
    egui_view_led_init_with_params(EGUI_VIEW_OF(&led_l), core, &led_l_params);
