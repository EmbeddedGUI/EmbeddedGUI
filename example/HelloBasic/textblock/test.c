...
// textblock_1: A short multi-line text with rounded border
EGUI_VIEW_TEXTBLOCK_PARAMS_INIT(textblock_1_params, 10, 10, 220, 80, "Multi-line\ntext block\nexample", EGUI_CONFIG_FONT_DEFAULT, EGUI_THEME_TEXT,
                                EGUI_ALPHA_100);
// textblock_2: Long text that overflows - demonstrates auto scrollbar and border
EGUI_VIEW_TEXTBLOCK_PARAMS_INIT(textblock_2_params, 10, 100, 220, 80,
                                "TextBlock now supports auto scrollbar when text is too long.\n"
                                "Line 2: You can scroll vertically.\n"
                                "Line 3: Rounded border shows boundary.\n"
                                "Line 4: Touch drag to scroll content.\n"
                                "Line 5: Horizontal overflow also works with very long lines that exceed the view width easily.",
                                EGUI_CONFIG_FONT_DEFAULT, EGUI_THEME_TEXT, EGUI_ALPHA_100);

void test_init_ui(void)
{
    // Init textblock_1: border enabled, no scroll needed
    ...
    // Init textblock_2: border + auto scrollbar for overflow text
    ...
    // textblock_1: (10,10,220,80)
    // textblock_2: (10,100,220,80)
