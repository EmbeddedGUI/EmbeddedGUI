...
static uint32_t demo_adapter_get_count(void *adapter_context)
{
    EGUI_UNUSED(adapter_context);
    return DEMO_NODE_COUNT;
}

static uint8_t demo_adapter_get_desc(void *adapter_context, uint32_t index, egui_virtual_stage_node_desc_t *out_desc)
{
...
static uint8_t demo_adapter_should_keep_alive(void *adapter_context, egui_view_t *view, uint32_t index, uint32_t stable_id, const egui_virtual_stage_node_desc_t *desc)
{
    EGUI_UNUSED(adapter_context);
    EGUI_UNUSED(index);
...
const egui_view_virtual_stage_adapter_t demo_adapter = {
        .get_count = demo_adapter_get_count,
        .get_desc = demo_adapter_get_desc,
        .create_view = demo_adapter_create_view,
        .destroy_view = demo_adapter_destroy_view,
        .bind_view = demo_adapter_bind_view,
        .unbind_view = NULL,
        .save_state = demo_adapter_save_state,
        .restore_state = demo_adapter_restore_state,
        .draw_node = demo_adapter_draw_node,
        .hit_test = demo_adapter_hit_test,
        .should_keep_alive = demo_adapter_should_keep_alive,
};
