...
EGUI_VIEW_LABEL_PARAMS_INIT(s_lp0, SWATCH_W, 0, SCREEN_W - SWATCH_W, ROW_H, "Style: PRIMARY", EGUI_CONFIG_FONT_DEFAULT, EGUI_THEME_TEXT_PRIMARY,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(s_lp1, SWATCH_W, ROW_H, SCREEN_W - SWATCH_W, ROW_H, "Stack: SECONDARY", EGUI_CONFIG_FONT_DEFAULT, EGUI_THEME_TEXT_PRIMARY,
                            EGUI_ALPHA_100);
EGUI_VIEW_LABEL_PARAMS_INIT(s_lp2, SWATCH_W, 2 * ROW_H, SCREEN_W - SWATCH_W, ROW_H, "Inline: SURFACE", EGUI_CONFIG_FONT_DEFAULT, EGUI_THEME_TEXT_PRIMARY,
                            EGUI_ALPHA_100);
