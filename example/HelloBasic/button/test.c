...
// Size XS (96x30)
EGUI_VIEW_BUTTON_PARAMS_INIT(button_xs_params, 0, 0, 96, 30, NULL, NULL, EGUI_THEME_TEXT, EGUI_ALPHA_100);
// Size S (120x34)
EGUI_VIEW_BUTTON_PARAMS_INIT(button_s_params, 0, 0, 120, 34, NULL, NULL, EGUI_THEME_TEXT, EGUI_ALPHA_100);
// Size M (160x38)
EGUI_VIEW_BUTTON_PARAMS_INIT(button_m_params, 0, 0, 160, 38, NULL, NULL, EGUI_THEME_TEXT, EGUI_ALPHA_100);
// Size L (200x44)
EGUI_VIEW_BUTTON_PARAMS_INIT(button_l_params, 0, 0, 200, 44, NULL, NULL, EGUI_THEME_TEXT, EGUI_ALPHA_100);
...
#define BUTTON_VERIFY_RETRY_MAX 3U

static uint8_t runtime_fail_reported;
static uint8_t button_click_counts[4];
static uint8_t button_verify_retries[4];
...
static uint8_t schedule_button_verify_retry(uint8_t verify_index, egui_sim_action_t *p_action)
{
    if (verify_index >= 4U || button_verify_retries[verify_index] >= BUTTON_VERIFY_RETRY_MAX)
    {
        return 0U;
    }

    button_verify_retries[verify_index]++;
...
void test_init_ui(egui_core_t *core)
{
    ...
    memset(button_verify_retries, 0, sizeof(button_verify_retries));
#endif
    // Init grid
    egui_view_gridlayout_init_with_params(EGUI_VIEW_OF(&grid), core, &grid_params);

    // Init button XS
    egui_view_button_init_with_params(EGUI_VIEW_OF(&button_xs), core, &button_xs_params);
    ...
    // Init button S
    egui_view_button_init_with_params(EGUI_VIEW_OF(&button_s), core, &button_s_params);
    ...
    // Init button M
    egui_view_button_init_with_params(EGUI_VIEW_OF(&button_m), core, &button_m_params);
    ...
    // Init button L
    egui_view_button_init_with_params(EGUI_VIEW_OF(&button_l), core, &button_l_params);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 4:
        ...
        {
            if (schedule_button_verify_retry(3U, p_action))
            {
                return true;
            }
        }
        button_verify_retries[3] = 0U;
        if (first_call)
        {
