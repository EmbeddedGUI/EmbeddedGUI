...
void test_init_ui(egui_core_t *core)
{
    ...
    // Init child items
    egui_view_switch_init_with_params(EGUI_VIEW_OF(&sw_1), core, &sw_1_params);
    egui_view_switch_init_with_params(EGUI_VIEW_OF(&sw_2), core, &sw_2_params);
    egui_view_switch_init_with_params(EGUI_VIEW_OF(&sw_3), core, &sw_3_params);
    egui_view_switch_init_with_params(EGUI_VIEW_OF(&sw_4), core, &sw_4_params);
    ...
    egui_view_layout_user_root(EGUI_VIEW_OF(&grid), EGUI_LAYOUT_VERTICAL, EGUI_ALIGN_CENTER);
}
