...
static const char *tab_texts[] = {"Home", "Profile", "Settings"};
static const char *tab_icons[] = {EGUI_ICON_MS_HOME, EGUI_ICON_MS_PERSON, EGUI_ICON_MS_SETTINGS};
...
EGUI_VIEW_LABEL_PARAMS_INIT(page_2_params, 0, 0, PAGE_WIDTH, PAGE_HEIGHT, "Profile Page", EGUI_CONFIG_FONT_DEFAULT, EGUI_THEME_TEXT_PRIMARY, EGUI_ALPHA_100);
