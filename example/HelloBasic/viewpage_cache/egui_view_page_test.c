...
void egui_view_page_test_sub_view_init(egui_view_t *self)
{
    ...
    egui_view_label_set_font_color((egui_view_t *)&local->label_1, EGUI_THEME_TEXT_PRIMARY, EGUI_ALPHA_100);

    // Add childs to layout_1
    egui_view_group_add_child((egui_view_t *)&local->base, (egui_view_t *)&local->label_1);

    // Set Background
    egui_view_set_background((egui_view_t *)&local->label_1, (egui_background_t *)bg_list[local->index % (sizeof(bg_list) / sizeof(bg_list[0]))]);
}
