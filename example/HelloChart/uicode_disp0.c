...
static void uicode_disp0_init_ui(egui_core_t *core)
{
    ...
    // ---- Line Chart ----
    egui_view_chart_line_init_with_params(EGUI_VIEW_OF(&chart_line), core, &chart_line_params);
    ...
    // ---- Scatter Chart ----
    egui_view_chart_scatter_init_with_params(EGUI_VIEW_OF(&chart_scatter), core, &chart_scatter_params);
    ...
    // ---- Bar Chart ----
    egui_view_chart_bar_init_with_params(EGUI_VIEW_OF(&chart_bar), core, &chart_bar_params);
    ...
    // ---- Pie Chart (no zoom) ----
    egui_view_chart_pie_init_with_params(EGUI_VIEW_OF(&chart_pie), core, &chart_pie_params);
    ...
    // ---- Toolbar ----
    egui_view_linearlayout_init_with_params(EGUI_VIEW_OF(&toolbar), core, &toolbar_params);

    egui_view_button_init_with_params(EGUI_VIEW_OF(&btn_zoom_out), core, &btn_zoom_out_params);
    ...
    egui_view_button_init_with_params(EGUI_VIEW_OF(&btn_zoom_reset), core, &btn_zoom_reset_params);
    ...
    egui_view_button_init_with_params(EGUI_VIEW_OF(&btn_zoom_in), core, &btn_zoom_in_params);
    ...
    // ---- Left Y-axis Toolbar ----
    egui_view_linearlayout_init_with_params(EGUI_VIEW_OF(&toolbar_y), core, &toolbar_y_params);

    egui_view_button_init_with_params(EGUI_VIEW_OF(&btn_zoom_y_out), core, &btn_zoom_y_out_params);
    ...
    egui_view_button_init_with_params(EGUI_VIEW_OF(&btn_zoom_y_reset), core, &btn_zoom_y_reset_params);
    ...
    egui_view_button_init_with_params(EGUI_VIEW_OF(&btn_zoom_y_in), core, &btn_zoom_y_in_params);
    ...
    // ---- Page Indicator ----
    egui_view_page_indicator_init_with_params(EGUI_VIEW_OF(&indicator), core, &indicator_params);
