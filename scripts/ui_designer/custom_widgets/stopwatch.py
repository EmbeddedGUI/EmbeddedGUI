"""Stopwatch widget plugin for EmbeddedGUI Designer."""
from ui_designer.model.widget_registry import WidgetRegistry

WidgetRegistry.instance().register(
    type_name="stopwatch",
    descriptor={
        "c_type": "egui_view_stopwatch_t",
        "init_func": "egui_view_stopwatch_init_with_params",
        ...
        "properties": {
            "elapsed_ms": {
                "type": "int", "default": 0,
                "ui_group": "main",
                "code_gen": {"kind": "setter", "func": "egui_view_stopwatch_set_elapsed"},
            },
            "show_ms": {
                "type": "int", "default": 1,
                "ui_group": "main",
                "code_gen": {"kind": "setter", "func": "egui_view_stopwatch_set_show_ms"},
            },
            "font_file": {
