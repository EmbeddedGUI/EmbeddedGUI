"""Button widget plugin for EmbeddedGUI Designer."""
from ui_designer.model.widget_registry import WidgetRegistry

WidgetRegistry.instance().register(
    type_name="button",
    descriptor={
        "c_type": "egui_view_button_t",
        "init_func": "egui_view_button_init_with_params",
        "params_macro": "EGUI_VIEW_BUTTON_PARAMS_INIT",
