"""DynamicLabel widget plugin for EmbeddedGUI Designer."""
from ui_designer.model.widget_registry import WidgetRegistry

WidgetRegistry.instance().register(
    type_name="dynamic_label",
    descriptor={
        "c_type": "egui_view_dynamic_label_t",
        "init_func": "egui_view_dynamic_label_init_with_params",
        ...
        "properties": {
            "text": {
                ...
                "ui_group": "main",
                "code_gen": {"kind": "text_setter", "func": "egui_view_dynamic_label_set_text"},
            },
            "font_file": {
    ...
    xml_tag="DynamicLabel",
    display_name="DynamicLabel",
)
