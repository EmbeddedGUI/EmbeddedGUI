"""Bar Chart widget plugin for EmbeddedGUI Designer."""
from ui_designer.model.widget_registry import WidgetRegistry

WidgetRegistry.instance().register(
    type_name="chart_bar",
    descriptor={
        "c_type": "egui_view_chart_bar_t",
        "init_func": "egui_view_chart_bar_init_with_params",
        "params_macro": "EGUI_VIEW_CHART_BAR_PARAMS_INIT",
        "params_type": "egui_view_chart_bar_params_t",
        "is_container": False,
        "add_child_func": None,
        "layout_func": None,
        "properties": {
            ...
            # --- bar-specific ---
            "bar_gap": {
                "type": "int", "default": 2, "min": 0, "max": 20,
                "ui_group": "style",
                "code_gen": {"kind": "setter",
                             "func": "egui_view_chart_bar_set_bar_gap",
                             "skip_default": True},
            },
        },
    },
    xml_tag="ChartBar",
    display_name="Chart Bar",
)
