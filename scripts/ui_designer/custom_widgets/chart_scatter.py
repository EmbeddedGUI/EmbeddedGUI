"""Scatter Chart widget plugin for EmbeddedGUI Designer."""
from ui_designer.model.widget_registry import WidgetRegistry

WidgetRegistry.instance().register(
    type_name="chart_scatter",
    descriptor={
        "c_type": "egui_view_chart_scatter_t",
        "init_func": "egui_view_chart_scatter_init_with_params",
        "params_macro": "EGUI_VIEW_CHART_SCATTER_PARAMS_INIT",
        "params_type": "egui_view_chart_scatter_params_t",
        "is_container": False,
        "add_child_func": None,
        "layout_func": None,
        "properties": {
            ...
            "point_radius": {
                ...
                "ui_group": "style",
                "code_gen": {"kind": "setter",
                             "func": "egui_view_chart_scatter_set_point_radius",
                             "skip_default": True},
            },
        },
    },
    xml_tag="ChartScatter",
    display_name="Chart Scatter",
)
