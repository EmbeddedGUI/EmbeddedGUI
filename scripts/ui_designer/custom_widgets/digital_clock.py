"""DigitalClock widget plugin for EmbeddedGUI Designer."""
from ui_designer.model.widget_registry import WidgetRegistry

WidgetRegistry.instance().register(
    type_name="digital_clock",
    descriptor={
        "c_type": "egui_view_digital_clock_t",
        "init_func": "egui_view_digital_clock_init_with_params",
        ...
        "properties": {
            "hour": {
                "type": "int", "default": 0,
                "ui_group": "main",
                "code_gen": {"kind": "multi_setter", "func": "egui_view_digital_clock_set_time",
                             "args": "{hour}, {minute}, {second}", "group": "time"},
            },
            "minute": {
                "type": "int", "default": 0,
                "ui_group": "main",
            ...
            "format_24h": {
                "type": "int", "default": 1,
                "ui_group": "main",
                "code_gen": {"kind": "setter", "func": "egui_view_digital_clock_set_format"},
            },
            "show_second": {
                "type": "int", "default": 1,
                "ui_group": "main",
                "code_gen": {"kind": "setter", "func": "egui_view_digital_clock_set_show_second"},
            },
            "font_file": {
    ...
    xml_tag="DigitalClock",
    display_name="DigitalClock",
)
