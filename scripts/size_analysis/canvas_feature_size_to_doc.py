...
REPORT_KEY = "canvas_feature_size_to_doc"
...
VARIANTS = [
    {
        ...
        "cflags": [
            ...
            "-DEGUI_CONFIG_FUNCTION_IMAGE_CODEC_QOI=0",
            "-DEGUI_CONFIG_FUNCTION_IMAGE_CODEC_RLE=0",
        ],
        "scenes": [],
    ...
    },
    {
        ...
        "cflags": [
            "-DEGUI_CONFIG_FUNCTION_SUPPORT_MASK=0",
            "-DEGUI_CONFIG_FUNCTION_IMAGE_CODEC_QOI=0",
            "-DEGUI_CONFIG_FUNCTION_IMAGE_CODEC_RLE=1",
    ...
    },
    {
        ...
        "cflags": [
            "-DEGUI_CONFIG_FUNCTION_SUPPORT_MASK=0",
            "-DEGUI_CONFIG_FUNCTION_IMAGE_CODEC_QOI=1",
            "-DEGUI_CONFIG_FUNCTION_IMAGE_CODEC_RLE=0",
