...
CATEGORY_GROUPS = [
    ...
    ("Widgets", [
        ...
        "FILE_IMAGE_BMP_PFB_TILED", "FILE_IMAGE_BMP_PFB_TILED_RESIZE",
        "IMAGE_SVG_PFB_TILED", "IMAGE_SVG_PFB_TILED_RESIZE",
        "EXTERN_IMAGE_SVG_PFB_TILED", "EXTERN_IMAGE_SVG_PFB_TILED_RESIZE",
