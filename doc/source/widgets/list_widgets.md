...
| 函数 | 说明 |
|------|------|
| `egui_view_list_view_init_with_setup(self, core, setup)` | 一次接好 `params + data_model + holder_ops + context` |
...
| 函数 | 说明 |
|------|------|
| `egui_view_grid_view_init_with_setup(self, core, setup)` | 一次接好 `params + data_model + holder_ops + context` |
...
| `egui_view_list_init_with_params(self, core, params)` | 使用参数初始化 |
...
| `egui_view_table_init_with_params(self, core, params)` | 使用参数初始化 |
...
| `egui_view_button_matrix_init_with_params(self, core, params)` | 使用参数初始化 |
...
void init_ui(egui_core_t *core)
{
    egui_view_button_matrix_init_with_params(
        EGUI_VIEW_OF(&btnmatrix), core, &bm_params);
