...
| 想确认当前 FPS、CPU 占用和 LCD latency | `EGUI_CONFIG_DEBUG_INFO_SHOW` | 保持其他宏关闭，避免互相干扰 |
...
| 想确认动画是否仍然是局部刷新 | `scripts/code_dirty_animation_check.py` | `scripts/dirty_region_stats_report.py` |
