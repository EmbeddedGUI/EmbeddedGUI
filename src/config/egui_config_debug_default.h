...
/**
 * Debug options.
 * EGUI memory monitor (current/peak tracked bytes from egui_api_malloc).
 */
...
#ifdef EGUI_PC_DEFAULT_DEBUG_LOG_LEVEL
#define EGUI_CONFIG_DEBUG_LOG_LEVEL EGUI_PC_DEFAULT_DEBUG_LOG_LEVEL
#else
