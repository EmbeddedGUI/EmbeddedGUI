...
__EGUI_OPTIMIZE_SIZE__ void egui_canvas_draw_circle_fill_gradient(egui_dim_t center_x, egui_dim_t center_y, egui_dim_t radius,
                                                                           const egui_gradient_t *gradient)
{
    egui_canvas_t *self = &canvas_data;
...
__EGUI_OPTIMIZE_SIZE__ void egui_canvas_draw_triangle_fill_gradient(egui_dim_t x1, egui_dim_t y1, egui_dim_t x2, egui_dim_t y2, egui_dim_t x3,
