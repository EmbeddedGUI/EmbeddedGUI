...
struct egui_image_api
{
    ...
    int (*get_point_resize)(const egui_image_t *self, egui_dim_t x, egui_dim_t y, egui_dim_t width, egui_dim_t height, egui_color_t *color,
                            egui_alpha_t *alpha);
    void (*draw_image)(const egui_image_t *self, egui_canvas_t *canvas, egui_dim_t x, egui_dim_t y);
    void (*draw_image_resize)(const egui_image_t *self, egui_canvas_t *canvas, egui_dim_t x, egui_dim_t y, egui_dim_t width, egui_dim_t height);
    void (*draw_image_color)(const egui_image_t *self, egui_canvas_t *canvas, egui_dim_t x, egui_dim_t y, egui_color_t color, egui_alpha_t alpha);
    void (*draw_image_resize_color)(const egui_image_t *self, egui_canvas_t *canvas, egui_dim_t x, egui_dim_t y, egui_dim_t width, egui_dim_t height,
