...
static int egui_image_qoi_get_size(const egui_image_t *self, egui_dim_t *width, egui_dim_t *height)
{
    const egui_image_qoi_info_t *info;
    ...
    info = (const egui_image_qoi_info_t *)self->res;
    if (width != NULL)
    {
        *width = info->width;
    }
...
const egui_image_api_t egui_image_qoi_t_api_table = {
        .get_size = egui_image_qoi_get_size,
