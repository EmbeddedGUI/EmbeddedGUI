#ifndef _EGUI_INTERPOLATOR_OVERSHOOT_H_
#define _EGUI_INTERPOLATOR_OVERSHOOT_H_
...
typedef struct egui_interpolator_overshoot egui_interpolator_overshoot_t;
struct egui_interpolator_overshoot
{
...
#endif /* _EGUI_INTERPOLATOR_OVERSHOOT_H_ */
