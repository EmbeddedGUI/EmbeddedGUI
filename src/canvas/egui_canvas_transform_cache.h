...
#if !EGUI_CONFIG_TEXT_TRANSFORM_LAYOUT_HEAP_ENABLE && EGUI_FONT_TRANSFORM_FAST_DRAW_ENABLED
#error "EGUI_CONFIG_TEXT_TRANSFORM_LAYOUT_HEAP_ENABLE=0 requires effective font transform fast draw to be disabled"
#endif
