...
static egui_view_t *egui_view_list_view_data_source_create_item_view(void *data_source_context, uint16_t view_type)
{
    ...
    host = (egui_view_list_view_item_host_t *)egui_malloc(sizeof(egui_view_list_view_item_host_t));
    if (host == NULL)
    {
        egui_view_list_view_destroy_holder_internal(local, holder, view_type);
        return NULL;
...
void egui_view_list_view_init_with_params(egui_view_t *self, const egui_view_list_view_params_t *params)
{
    egui_view_list_view_init(self);
...
void egui_view_list_view_init_with_setup(egui_view_t *self, const egui_view_list_view_setup_t *setup)
{
    egui_view_list_view_init(self);
...
void egui_view_list_view_init(egui_view_t *self)
{
    EGUI_LOCAL_INIT(egui_view_list_view_t);
