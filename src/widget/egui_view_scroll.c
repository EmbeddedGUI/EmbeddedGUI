...
EGUI_VIEW_API_DEFINE_BASE_GROUP(egui_view_scroll_t, NULL, egui_view_scroll_on_touch_event, egui_view_scroll_on_intercept_touch_event,
                                egui_view_scroll_compute_scroll, NULL, NULL, NULL, NULL, NULL, NULL);
