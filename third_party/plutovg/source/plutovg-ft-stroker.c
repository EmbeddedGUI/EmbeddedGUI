...
static PVG_FT_Bool ft_cubic_is_small_enough(PVG_FT_Vector *base, PVG_FT_Angle *angle_in, PVG_FT_Angle *angle_mid, PVG_FT_Angle *angle_out)
{
...
#define PVG_FT_STROKE_TAG_BEGIN_END (PVG_FT_STROKE_TAG_BEGIN | PVG_FT_STROKE_TAG_END)
...
static PVG_FT_Error ft_stroke_border_lineto(PVG_FT_StrokeBorder border, PVG_FT_Vector *to, PVG_FT_Bool movable)
{
    ...
    else
    {
        ...
        if (border->num_points > (PVG_FT_UInt)border->start && PVG_FT_IS_SMALL(border->points[border->num_points - 1].x - to->x) &&
...
static PVG_FT_Error ft_stroke_border_cubicto(PVG_FT_StrokeBorder border, PVG_FT_Vector *control1, PVG_FT_Vector *control2, PVG_FT_Vector *to)
{
    PVG_FT_Error error;
...
static PVG_FT_Error ft_stroke_border_arcto(PVG_FT_StrokeBorder border, PVG_FT_Vector *center, PVG_FT_Fixed radius, PVG_FT_Angle angle_start,
...
static PVG_FT_Error ft_stroke_border_get_counts(PVG_FT_StrokeBorder border, PVG_FT_UInt *anum_points, PVG_FT_UInt *anum_contours)
{
    PVG_FT_Error error = 0;
...
void PVG_FT_Stroker_Set(PVG_FT_Stroker stroker, PVG_FT_Fixed radius, PVG_FT_Stroker_LineCap line_cap, PVG_FT_Stroker_LineJoin line_join,
                        PVG_FT_Fixed miter_limit)
{
...
PVG_FT_Error PVG_FT_Stroker_ConicTo(PVG_FT_Stroker stroker, PVG_FT_Vector *control, PVG_FT_Vector *to)
{
    ...
    if (PVG_FT_IS_SMALL(stroker->center.x - control->x) && PVG_FT_IS_SMALL(stroker->center.y - control->y) && PVG_FT_IS_SMALL(control->x - to->x) &&
...
PVG_FT_Error PVG_FT_Stroker_CubicTo(PVG_FT_Stroker stroker, PVG_FT_Vector *control1, PVG_FT_Vector *control2, PVG_FT_Vector *to)
{
    PVG_FT_Error error = 0;
    ...
    /* if all control points are coincident, this is a no-op; */
    /* avoid creating a spurious corner */
    if (PVG_FT_IS_SMALL(stroker->center.x - control1->x) && PVG_FT_IS_SMALL(stroker->center.y - control1->y) && PVG_FT_IS_SMALL(control1->x - control2->x) &&
        PVG_FT_IS_SMALL(control1->y - control2->y) && PVG_FT_IS_SMALL(control2->x - to->x) && PVG_FT_IS_SMALL(control2->y - to->y))
    {
        stroker->center = *to;
        goto Exit;
    }
...
PVG_FT_Error PVG_FT_Stroker_BeginSubPath(PVG_FT_Stroker stroker, PVG_FT_Vector *to, PVG_FT_Bool open)
{
    ...
    stroker->handle_wide_strokes =
            PVG_FT_BOOL(stroker->line_join != PVG_FT_STROKER_LINEJOIN_ROUND || (stroker->subpath_open && stroker->line_cap == PVG_FT_STROKER_LINECAP_BUTT));
...
PVG_FT_Error PVG_FT_Stroker_GetBorderCounts(PVG_FT_Stroker stroker, PVG_FT_StrokerBorder border, PVG_FT_UInt *anum_points, PVG_FT_UInt *anum_contours)
{
